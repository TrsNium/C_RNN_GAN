...
if __name__ == "__main__":
    ...
    parser.add_argument("--pretrain_itrs", dest="pretrain_itrs", type=int, default=401)
    ...
    parser.add_argument("--dis_rnn_size", dest="dis_rnn_size", type=int, default=1024)
    ...
    parser.add_argument("--atribute_inputs", dest="atribute_inputs", type=list, default=[0,0,1])
